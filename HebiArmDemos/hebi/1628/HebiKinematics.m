classdef (Sealed) HebiKinematics
    ...
    %      setPayload            -  sets a payload for torque compensation
    %
    %   Example
    ...
    methods(Access = public)
        ...
        function this = setPayload(this, varargin)
            % setPayload sets a payload used for torque compensation
            %
            %   This method provides a way to dynamically specify a payload
            %   that gets used to calculate torques to compensate for
            ...
            %
            %   See also HebiKinematics, getGravCompTorques, 
            %   getDynamicCompTorques
