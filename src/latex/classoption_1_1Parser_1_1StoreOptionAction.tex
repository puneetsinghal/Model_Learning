...
\begin{center}
\leavevmode
\includegraphics[width=214pt]{classoption_1_1Parser_1_1StoreOptionAction__inherit__graph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=214pt]{classoption_1_1Parser_1_1StoreOptionAction__coll__graph}
\end{center}
\end{figure}
