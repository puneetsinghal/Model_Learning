					 ...
					 const Eigen::VectorXd &alpha,std::vector<double> &torque)
{
	...
	comp_torque = Inertia*alpha + Corriolis*omega + gravity_torque
				  + ViscousFriction*omega;
...
static void corriolis(const Eigen::VectorXd &theta,
					  const Eigen::VectorXd &omega,Eigen::MatrixXd &Corriolis)
{
	//Masses of each of the links
	double m[5] = {0.6216,0.6616,0.6416,0.4014,0};
	//Center of mass of each link
